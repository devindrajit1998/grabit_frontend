        ...
        <div className="mx-[-12px]">
          <div className="w-full flex flex-wrap">
            ...
            <div className="min-[768px]:w-[50%] w-full px-[12px]">
              ...
              >
                <h2 className="text-[#4b5966] block text-[22px] leading-[33px] font-semibold mb-[10px] mx-auto leading-[0] capitalize">
                  Newsletter.
                </h2>
                <p className="text-[15px] leading-[28px] font-light mb-[1rem]">
                  Subscribe the masterkart to get in touch and get the future
                  update.
                </p>
